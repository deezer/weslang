...
public class DetectorFactory {
    ...
    private static final String profilesFile = profilesPath + "profiles.txt";
    ...
    private static String getStringFromFile(String uri) throws IOException, UnsupportedEncodingException{
        InputStream is = DetectorFactory.class.getResourceAsStream(uri);
